package com.app.codemasterpiecebackend.global.support.response;

import com.app.codemasterpiecebackend.global.support.web.SuccessWrappingAdvice;

/**
 * 컨트롤러가 응답 시 데이터를 직접 반환하지 않고,
 * 메시지 코드/인자를 함께 전달할 수 있도록 하는 중간 DTO.
 * {@link SuccessWrappingAdvice}에서
