...
public class AppUserDetails implements OAuth2User {
    ...
    public AppUserDetails(String userId, String avatarUrl, String avatarUrlSmall, String nickname, RoleType role, ActorProvider provider, Map<String, Object> attributes) {
        this.appUser = new AppUser(userId, avatarUrl, avatarUrlSmall, nickname, role, provider);
