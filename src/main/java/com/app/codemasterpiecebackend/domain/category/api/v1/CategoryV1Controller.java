...
public class CategoryV1Controller {
    ...
    public SuccessPayload<Void> createCategory(
            @Valid @ModelAttribute CategoryRequest.Create body
    ) {
    ...
    public SuccessPayload<Void> updateCategory(
            ...
            @Valid @ModelAttribute CategoryRequest.Update body
    ) {
    ...
    @PreAuthorize("hasRole('AUTHOR')")
    public SuccessPayload<Void> moveCategory(@RequestBody @Valid CategoryRequest.Move body) {
