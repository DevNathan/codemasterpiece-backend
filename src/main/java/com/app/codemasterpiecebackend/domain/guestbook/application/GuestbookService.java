...
public interface GuestbookService {
     ...
     * @return 생성된 엔트리 DTO
     */
    EntryDTO create(GuestbookCommand.Create cmd);
     ...
     * @return 엔트리 DTO 슬라이스
     */
    Slice<EntryDTO> getSlice(GuestbookCommand.Slice cmd);
     ...
     * @return 수정된 엔트리 DTO
     */
    EntryDTO update(GuestbookCommand.Update cmd);
     ...
     * @param cmd 삭제 커맨드
     */
    void delete(GuestbookCommand.Delete cmd);
}
