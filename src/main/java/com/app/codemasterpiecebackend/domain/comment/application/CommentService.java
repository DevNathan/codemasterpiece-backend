...
public interface CommentService {
     ...
     */
    CommentDTO create(CommentCommand.Create cmd);
     ...
     */
    Page<CommentDTO> getPageByPostId(CommentCommand.View cmd);

    String getRawContent(CommentCommand.Raw cmd);
     ...
     */
    CommentDTO update(CommentCommand.Update cmd);
     ...
     */
    boolean toggleHide(CommentCommand.Like cmd);
     ...
     */
    void delete(CommentCommand.Delete cmd);
     ...
     */
    ReactionValue react(CommentCommand.React cmd);
}
